      ...
      function render() {
        ...
        if (sections) {
          ...
          el = $("<div class='fc-toolbar'/>")
            .append($('<div class="fc-center" id="leftsection"/>').append($('<div class="calender-heading"/>').append('<div class="icon-heading"> <img src="'+frontendURL+'/static/assets/svg/Calendar.svg"> <h4 class="mx-1"> Calender </h4></div>').append((renderSection("center")))))
  ...
  */
  ...
  function getevents(day,month,year,already_existdatelist){
    eventslist=[]
    $.ajax({
    url: frontendURL +"getshiftevents",
    type: 'POST',
    data:{
        'day':day,
        'month':month,
    ...
    success: function(response){
       ...
       // console.log("success",response.data)
        ...
        // calendar.fullCalendar('renderEvent', eventslist);
